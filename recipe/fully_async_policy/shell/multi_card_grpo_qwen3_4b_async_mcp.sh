...
top_p=0.95
top_k=20
model_path="/workspace/verl/mcp_agent_ckpts/Qwen3-4B-2507-correct-1114-128K/hf_global_step_4800"
...
TRAINER_NGPUS_PER_NODE=${TRAINER_NGPUS_PER_NODE:-8}
...
default_local_dir="/workspace/verl/mcp_agent_ckpts/$experiment_name"
validation_dir="/workspace/verl/rollout_data/$experiment_name-validation"
rollout_dir="/workspace/verl/rollout_data/$experiment_name-train"
test_freq=300
total_epochs=15
