# conda activate vllm
# nohup bash /nfsdata/fanshengda/verl/examples/PRM_from_ORM/run_qwen3-4b-group—AgentProcessBench.sh > ./near_miss_prm_logs/run_qwen3_4B_GROUP_$(date +"%Y%m%d_%H%M%S").log 2>&1 &
