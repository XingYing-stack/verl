...
model_path="/workspace/fanshengda/verl/mcp_agent_ckpts/Qwen3-4B-2507-all_valid_messages_tydpr_deepdive-1104/hf_global_step_584"
...
experiment_name="qwen3-4b-sync-DAPO_TongYi_1104SFT_ckpt584-n${rollout_num}-webshaper-turn${max_turns}-warning_ratio${context_warning_ratio}-ppo_epochs${ppo_epochs}"
python3 -m recipe.dapo.main_dapo \
    ...
    data.train_files=/workspace/fanshengda/verl/input_data/webshaper/tongyi_webshaper_LLMJudge_docker222.parquet \
    data.val_files=/workspace/fanshengda/verl/input_data/gaia_dev/tongyi_dev_TextOnly_LLMJudge_docker222.parquet \
