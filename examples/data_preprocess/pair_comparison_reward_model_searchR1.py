...
if __name__ == "__main__":
    ...
    parser.add_argument("--metadata_path",
                        default="/workspace/fanshengda/verl/input_data/near_miss_pairs_1106.pkl")
    ...
    train_path = os.path.join(local_dir, 'train_1106.parquet')
    val_path = os.path.join(local_dir, 'validation_1106.parquet')
