# (base) fanshengda@node1040:~/verl$ nohup bash ./PRM_from_ORM/run_math_process_judge_grpo.sh > "./PRM_from_ORM/logs/run_math_process_judge_$(date +"%Y%m%d_%H%M%S").log" 2>&1 < /dev/null &
#
set -x
ulimit -n 65535
